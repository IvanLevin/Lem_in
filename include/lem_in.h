...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/08/03 17:14:58 by breolson          #+#    #+#             */
/*   Updated: 2019/08/03 17:17:57 by breolson         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					create_and_get_adjacency_lists (t_graf *graf, \
		t_lem **lem);
void					set_groups(t_lem *lem, t_stream *streams, \
		t_groups **groups);
void					communication_rooms(t_lem **lem, t_graf **graf, \
		char **line);
void					put_way_ants(t_lem *lem, t_stream *streams, \
		t_groups *groups);
...
int						map_with_hash(char **line, t_lem **lem, t_graf **graf, \
		t_char **inf);
